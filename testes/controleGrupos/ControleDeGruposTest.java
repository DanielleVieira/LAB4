...
//		assertEquals("Grupo n�o cadastrado.", this.cg1.alocarAluno("250", "Padr�es de Design"));
		// aluno nao cadastrado
//		assertEquals("Aluno n�o cadastrado.", this.cg1.alocarAluno("6000", "listas"));
		//grupo invalido
//		assertEquals("Grupo n�o cadastrado.", this.cg1.alocarAluno("250", ""));
		//matricula invalida
//		assertEquals("Aluno n�o cadastrado.", this.cg1.alocarAluno("", "listas"));
//		assertEquals("Aluno n�o cadastrado.", this.cg1.alocarAluno(null, "listas"));
	}
	...
	public void testAlocarAlunoGrupoNaoCadastrado() {
		this.cg1.alocarAluno("250", "Padr�es de Design");
	}
